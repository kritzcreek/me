...
* "Blogging"
  ...
  First I require the =ox-publish= package as described in the
  [[http://orgmode.org/worg/org-tutorials/org-publish-html-tutorial.html#sec-3][org-mode docs]]. I also define the stylesheets and fonts that go into
...
*** Boot
    ...
    #+BEGIN_SRC clojure :tangle "~/.boot/profile.boot" :comments org
    (require 'boot.repl)
...
*** Leiningen
    ...
    #+BEGIN_SRC clojure :tangle ~/.lein/profiles.clj :comments org
