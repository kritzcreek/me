...
* Ruby
  ...
  #+BEGIN_SRC sh
  command -v rvm >/dev/null 2>&1 && [[ -s "$HOME/.rvm/scripts/rvm" ]] && . "$HOME/.rvm/scripts/rvm"
  #+END_SRC
...
* Python
  ...
  #+BEGIN_SRC sh
  command -v pyenv >/dev/null 2>&1 && export PATH="$HOME/.pyenv/bin:$PATH" && eval "$(pyenv init -)" && eval "$(pyenv virtualenv-init -)"
  #+END_SRC
