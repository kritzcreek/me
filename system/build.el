...
;; Original Author: Howard Abrams -- https://github.com/howardabrams/dot-files/blob/master/build.el
;;
...
;; My special functions for this script are not in a loadable location.
(require 'shell-script-funcs
	 (concat (file-name-directory (buffer-file-name))
		 "elisp/shell-script-funcs.el"))

;; Need to get the directory to my dotfiles souce code. While
